...
async function formatPostDetailBeforeReturn(post: PostService, lang: string = "vi") {
    const postResponse: PostResponse = {
        ...
        company_size: (post as any).company_size,
        province_id: post.province_id,
        province: post.province,
        province_name: post.province_name,
        description_application: post.description_application,
...
export { formatPostDetailBeforeReturn };
